...
> Crie um serviço RESTful em Spring Boot para gerenciar pedidos. O objetivo é praticar
mapeamento JPA com tipos de data/hora e operações CRUD.
---
...
- Crie uma entidade JPA chamada Pedido com os atributos especificados 
- Configure o nome da entidade JPA como Pedido 
- Configure o nome da tabela no banco como tb_pedido 
...
- Crie um controlador REST que exponha os seguintes endpoints: GET, GET(ID), POST, DELETE, PUT
